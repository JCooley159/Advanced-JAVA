...
public class TreeAssignment {
    ...
    public static void main(String[] args) {
        ...
        IntTree theTree = new IntTree(10); // changed to size 10 ~J.Cooley
        ...
        // call second user developmed routine to sum the values of all the integers in
        // the tree
    ...
    // can use the toString() method to print the tree
