...
public class TravelocityTest
{
    ...
    private static ArrayList<String> destinations = new ArrayList<String>();
    ...
    @BeforeClass
    public static void loadIn() throws MalformedURLException
    {
       ...
       // destinations.add("Singapore");
        ...
        // System.setProperty("webdriver.chrome.driver", "C:\\Users\\Jeremy6\\Downloads\\chromedriver_win32y\\chromedriver.exe");
        //        System.setProperty("webdriver.chrome.driver", "C:\\Users\\kaise\\Documents\\chromedriver.exe");
        driver = new ChromeDriver(options);
	    // driver = new RemoteWebDriver(new URL("https://travelocity.com"), options);
...
//            if(startMonth == 5 || startMonth == 7) { monthMax = 31; }
            ...
            for (int startDay =1; startDay <= monthMax; startDay++)
            {
	            ...
	            // Currently set to the end of May for testing
